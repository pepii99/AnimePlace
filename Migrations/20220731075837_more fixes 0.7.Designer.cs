...
namespace AnimePlace.Migrations
{
    ...
    [Migration("20220731075837_more fixes 0.7")]
    partial class morefixes07
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimePlace.Models.Anime", b =>
                {
                    ...
                    b.HasIndex("CurrentlyWatchingListId");
            ...
            modelBuilder.Entity("AnimePlace.Models.Anime", b =>
                {
                    b.HasOne("AnimePlace.Models.CurrentlyWatchingList", null)
                        .WithMany("CurrentlyWatchingAnimesList")
                        .HasForeignKey("CurrentlyWatchingListId");
                });
            ...
            modelBuilder.Entity("AnimePlace.Models.CurrentlyWatchingList", b =>
                {
                    b.Navigation("CurrentlyWatchingAnimesList");
                });
